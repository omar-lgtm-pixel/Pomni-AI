...
const client = new Client({
  phoneNumber: '447476685375', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "447476685375@lid", jid: "972569311531@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "447476685375@lid", jid: "201144480436@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "447476685375", lid: "50414477168824@lid" },
  // Owner 4 
   { name: "عمورتي", jid: "447476685375@s.whatsapp.net", lid: "51664513925368@lid" }
  ],
